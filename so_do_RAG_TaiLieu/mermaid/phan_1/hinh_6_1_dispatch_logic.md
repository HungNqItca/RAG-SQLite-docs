...
flowchart TB
    ...
    CLF{"<b>ContentTypeClassifier</b><br/>8 rule-based rules<br/>~0ms"}
    ...
    RDR["<b>R_DOC_REF:</b> mã VB pháp lý<br/>15/2024/TT-NHNN<br/><b>LEGAL · conf=0.92</b>"]
